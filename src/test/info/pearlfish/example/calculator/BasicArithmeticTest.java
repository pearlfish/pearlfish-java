...
import info.pearlfish.results.Scenario;
...
import static info.pearlfish.results.Results.*;

@SuppressWarnings("unchecked")
public class BasicArithmeticTest {
    @Rule
    public ApprovalRule<Object> approval = new ApprovalRule<Object>("src/test", MARKDOWN);
